...
## 🚀 Future Improvements
- Implement attention mechanisms to further improve classification performance
- Experiment with larger Arabic pre-trained models like AraBERT or MARBERT
- Expand the dataset with more diverse sources and topics
- Implement cross-validation to ensure robust model evaluation
- Add more sophisticated evaluation metrics for text generation
- Create a web interface for interactive text generation demo
...
3. Abdul-Mageed, M., et al. (2021). "ARBERT & MARBERT: Deep Bidirectional Transformers for Arabic." *arXiv preprint arXiv:2101.01785*.
...
<p align="center">
  ...
  <b>Supervised by:</b> Prof. ELAACHAk LOTFI<br>
  <b>Institution:</b> Université Abdelmalek Essaadi<br>
  Faculty of Science and Technology, Tangier<br>
  Master: MBD
</p>
...
<p align="center">
  ...
  <a href="https://github.com/yourusername/deep-learning-lab3">
    <img src="https://img.shields.io/github/stars/yourusername/deep-learning-lab3?style=social" alt="GitHub stars">
  </a>
</p>
